              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("رمز التحقق", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Color(0xFF334EAC))),
                      const SizedBox(height: 12),
                      Text("أدخل رمز التحقق المرسل إلى", style: TextStyle(fontSize: 16, color: Color(0xFF081F5C))),
                      Text(user.email, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF081F5C))),
                      const SizedBox(height: 24),

                      Obx(() => controller.error.value != null
                          ? Text(controller.error.value!, style: const TextStyle(color: Colors.red, fontWeight: FontWeight.w600))
                          ...
                          return Flexible(
                            child: Container(
                              ...
                              child: TextField(
                                ...
                                style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF334EAC)),
                      ...
                      TextButton(
                        onPressed: () async {
                          final response =await ApiService.refreshCode(user.id);
                        ...
                        child: const Text("إعادة إرسال الرمز؟", style: TextStyle(color: Color(0xFF334EAC), fontWeight: FontWeight.bold, fontSize: 16)),
                      ),
                    ],
                  ),
                ),
