                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: const Color(0xFF334EAC).withOpacity(0.18),
                          blurRadius: 16,
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: selected ? const Color(0xFF334EAC) : Colors.transparent,
                shape: BoxShape.circle,
                boxShadow: selected
                    ? [
                        BoxShadow(
              ...
              child: Icon(
                icon,
                color: selected ? Colors.white : const Color(0xFF334EAC),
                size: 26,
              ),
            ),
            ...
            AnimatedDefaultTextStyle(
              ...
              style: TextStyle(
                color: selected ? const Color(0xFF334EAC) : Colors.grey,
